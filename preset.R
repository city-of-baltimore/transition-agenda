#produce content and functions for ui and server
  ...
  # Fonts, Colors, and Icons 
   ...
   text1 <- div(HTML("<h5>Draft: As part of his administrative transition process in late 2020, Mayor Brandon Scott assembled a team of advocates, community leaders, and specialists, all with a passion for Baltimore and desire to improve City government. 
    This team developed immediate and long-term strategies for Baltimore's equitable growth. Mayor Scott reviewed these plans and built a coordinated strategy for his first term, starting with this Hundred Days of Action.
    Follow updates across each of these actions and track their completion using this tracker.</h5>"))
