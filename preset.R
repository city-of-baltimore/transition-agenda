#produce content and functions for ui and server
  ...
  # Fonts, Colors, and Icons 
   ...
   text1 <- div(HTML("<h5>Draft: As part of his transition process, Mayor Scott assembled a team of advocates, community leaders, and specialists, which developed immediate and long-term strategies for Baltimore's equitable growth. Mayor Scott reviewed these plans and built a coordinated strategy for his first term, starting with this Hundred Days of Action.
